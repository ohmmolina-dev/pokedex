<template>
   <svg class="fill-gray-700" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	      viewBox="0 0 69.961 69.961" style="enable-background:new 0 0 69.961 69.961;" xml:space="preserve">
            <g>
